...
from relu_alpha import BoundReLU
...
class BoundedSequential(nn.Sequential):
    ...
    def full_boundpropogation(self, x_U=None, x_L=None, upper=True, lower=True, optimize=0):
        ...
        ub, lb = self.boundpropogate_from_layer(x_U=x_U, x_L=x_L,
                                              ...
                                              lower=lower, start_node=i, optimize=0, out_features = modules[i].out_features)
